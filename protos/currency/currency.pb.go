...
// CurrencyCode is an enum to store the currency designator of countries
type CurrencyCode int32

const (
	CurrencyCode_EUR CurrencyCode = 0
	CurrencyCode_USD CurrencyCode = 1
	CurrencyCode_JPY CurrencyCode = 2
	CurrencyCode_BGN CurrencyCode = 3
	CurrencyCode_CZK CurrencyCode = 4
	CurrencyCode_DKK CurrencyCode = 5
	CurrencyCode_GBP CurrencyCode = 6
	CurrencyCode_HUF CurrencyCode = 7
	CurrencyCode_PLN CurrencyCode = 8
	CurrencyCode_RON CurrencyCode = 9
	CurrencyCode_SEK CurrencyCode = 10
	CurrencyCode_CHF CurrencyCode = 11
	CurrencyCode_ISK CurrencyCode = 12
	CurrencyCode_NOK CurrencyCode = 13
	CurrencyCode_HRK CurrencyCode = 14
	CurrencyCode_RUB CurrencyCode = 15
	CurrencyCode_TRY CurrencyCode = 16
	CurrencyCode_AUD CurrencyCode = 17
	CurrencyCode_BRL CurrencyCode = 18
	CurrencyCode_CAD CurrencyCode = 19
	CurrencyCode_CNY CurrencyCode = 20
	CurrencyCode_HKD CurrencyCode = 21
	CurrencyCode_IDR CurrencyCode = 22
	CurrencyCode_ILS CurrencyCode = 23
	CurrencyCode_INR CurrencyCode = 24
	CurrencyCode_KRW CurrencyCode = 25
	CurrencyCode_MXN CurrencyCode = 26
	CurrencyCode_MYR CurrencyCode = 27
	CurrencyCode_NZD CurrencyCode = 28
	CurrencyCode_PHP CurrencyCode = 29
	CurrencyCode_SGD CurrencyCode = 30
	CurrencyCode_THB CurrencyCode = 31
	CurrencyCode_ZAR CurrencyCode = 32
)
...
type RateRequest struct {
	...
	Base CurrencyCode `protobuf:"varint,1,opt,name=Base,proto3,enum=CurrencyCode" json:"Base,omitempty"`
	// Destination is the destination currency code for the rate
	Destination CurrencyCode `protobuf:"varint,2,opt,name=Destination,proto3,enum=CurrencyCode" json:"Destination,omitempty"`
}
...
func (x *RateRequest) GetBase() CurrencyCode {
	if x != nil {
		return x.Base
	}
...
func (x *RateRequest) GetDestination() CurrencyCode {
	if x != nil {
...
var file_currency_proto_rawDesc = []byte{
	...
	,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x63, 0x75, 0x72, 0x72, 0x65,
...
var file_currency_proto_goTypes = []interface{}{
	(CurrencyCode)(0),    // 0: CurrencyCode
	(*RateRequest)(nil),  // 1: RateRequest
	(*RateResponse)(nil), // 2: RateResponse
}
var file_currency_proto_depIdxs = []int32{
	0, // 0: RateRequest.Base:type_name -> CurrencyCode
	0, // 1: RateRequest.Destination:type_name -> CurrencyCode
